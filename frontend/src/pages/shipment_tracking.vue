        ...
        <div class="container">
            <h1 style="padding-left: 380px;padding-bottom: 20px;"><b></b>Shipment Tracking</h1>
                <div class="row mb-3">
                    ...
                    <div class="col-sm-9">
                    <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Tracking no. /Order No." v-model="tracking">
                    </div>
                </div>
...
export default {
    ...
    methods: {
        async fetchDetails() {
            ...
            const response = await axios.post('/api/method/logistics.api.tracking_details',{data:values},{
                                    headers:{
